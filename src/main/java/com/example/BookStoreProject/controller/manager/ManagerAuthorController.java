...
public class ManagerAuthorController {
    ...
    ResponseEntity<HttpStatus> updateName(@RequestBody AuthorUpdateNameDtoRequest request, Principal principal){
        authorService.updateAuthorName(principal,request);
        return new ResponseEntity<>(HttpStatus.OK);
    }
    @PutMapping("/update/description")
    ResponseEntity<HttpStatus> updateDescription(@RequestBody AuthorUpdateDescriptionDtoRequest request,Principal principal){
